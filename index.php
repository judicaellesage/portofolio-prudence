...
<body
    class="antialiased text-lg leading-[30px] font-primary text-dark dark:bg-semidark dark:text-white scrollbar-thumb-dark/25 scrollbar-track-dark/10 scrollbar-thin">
    <!-- Start Preloader-->
    <div id="preloader">
        ...
        <div class="container">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[50px]">
                <div class="text-center wow fadeInUp" data-wow-duration="1s">
                    ...
                    <div class="mt-[30px]">
                        <h3 class="text-2xl">Efficace</h3>
                        <p class="mx-auto text-muted dark:text-darkmuted mt-5 leading-[30px]">Capable de travailler de
                            manière organisée et structurée pour atteindre ses objectifs avec succès, en utilisant ses
                            compétences et ses ressources de manière optimale.</p>
                    </div>
                </div>
                <div class="text-center wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.2s">
                    ...
                    <div class="mt-[30px]">
                        <h3 class="text-2xl">Organisé</h3>
                        <p class="mx-auto text-muted dark:text-darkmuted mt-5 leading-[30px]">Capable de gérer
                            efficacement le temps et les tâches, en créant des systèmes et des processus qui me
                            permettent de travailler de manière productive et de respecter les délais.</p>
                    </div>
                </div>
                <div class="text-center wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.4s">
                    ...
                    <div class="mt-[30px]">
                        <h3 class="text-2xl">Créatif</h3>
                        <p class="mx-auto text-muted dark:text-darkmuted mt-5 leading-[30px]">Capable de penser en
                            dehors des sentiers battus, de proposer des idées originales et innovantes, et de concevoir
                            des solutions novatrices pour résoudre les problèmes.</p>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="top-[120px] -left-20 md:absolute">
                        <div
                            ...
                            <h3 class="text-[50px] text-[#1cbe59]"><span class="dizme_tm_counter stop" data-from="0"
                                    data-to="18" data-speed="2000">04</span></h3>
                    ...
                    <div class="bottom-[70px] -right-[30px] md:absolute">
                        <div
                            ...
                            <h3 class="text-[50px] text-[#6e50f0] dark:text-[#f0c45c]"><span
                                    class="dizme_tm_counter stop" data-from="0" data-to="9" data-speed="2000">90</span>
                            </h3>
                            <span class="name text-lg font-secondary leading-[1.3] font-medium">
                                Projets<br />
                                Totaux
                ...
                <div class="text-center md:text-left">
                    <div class="mb-[25px] lg:max-w-[440px]">
                        <p class="text-custom text-xl md:text-2xl font-medium font-secondary wow fadeInUp"
                            data-wow-duration="1s">Je suis aussi community manager</p>
                        <h3 class="md:text-[48px] text-[35px] leading-[1.25] mt-1.5 wow fadeInUp"
                            data-wow-duration="1s">Je peux gérer toutes vos pages sociaux</h3>
                    </div>
                    <p class="text-muted dark:text-darkmuted lg:max-w-[485px] leading-[30px] mb-[47px] wow fadeInUp"
                        data-wow-duration="1s">
                        En tant que chargé de communication, je suis passionné par l'art de communiquer des messages
                        clairs et percutants pour atteindre les objectifs de l'entreprise. Mon approche créative et
                        orientée résultats me permet de travailler en étroite collaboration avec les équipes internes et
                        les parties prenantes externes pour obtenir des résultats significatifs.
                    </p>
                    <div class="wow fadeInUp" data-wow-duration="1s">
                        <a href="#contact" class="btn-custom">Engagez Moi</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-[200px] items-center">
                <div>
                    <div class="mb-[23px] wow fadeInUp" data-wow-duration="1s">
                        <p class="text-custom text-[20px] md:text-2xl font-medium font-secondary">Compétences</p>
                        <h3 class="md:text-[48px] text-[35px] leading-[1.25] mt-1.5">Je développe mes compétences pour
                            me tenir à jour</h3>
                    </div>
                    <p class="text-muted dark:text-darkmuted lg:max-w-[485px] leading-[30px] wow fadeInUp"
                        data-wow-duration="1s"></p>
                    <div class="pt-[30px] space-y-[22px] wow fadeInUp" data-wow-duration="1s">
                        ...
                        <div class="w-full mb-[22px] relative" data-value="75" data-color="#f75023">
                            <div class="mb-[9px] block"><span
                                    class="text-lg font-medium font-secondary inline-block">Adobe Premier
                                    Pro</span><span class="absolute right-[25%] text-custom">90%</span></div>
                            <div class="w-full bg-[#e7e5f1] rounded-full h-2">
                        ...
                        <div class="w-full mb-[22px] relative" data-value="95" data-color="#f75023">
                            <div class="mb-[9px] block"><span
                                    class="text-lg font-medium font-secondary inline-block">WordPress</span><span
                                    class="absolute right-[5%] text-custom">95%</span></div>
                            <div class="w-full bg-[#e7e5f1] rounded-full h-2">
                                <div class="bg-[#1cbe59] h-2 rounded-full" style="width: 95%;"></div>
                            </div>
                        ...
                        <div class="w-full mb-[22px] relative" data-value="85" data-color="#f75023">
                            <div class="mb-[9px] block"><span
                                    class="text-lg font-medium font-secondary inline-block">Office 365</span><span
                                    class="absolute right-[15%] text-custom">98%</span></div>
                            <div class="w-full bg-[#e7e5f1] rounded-full h-2">
                                <div class="bg-custom h-2 rounded-full" style="width: 85%;"></div>
                            </div>
                        </div>
        ...
        <div class="container relative z-10">
            <div class="grid grid-cols-1">
                <div class="text-center max-w-[680px] mx-auto">
                    <p class="text-custom text-[20px] md:text-2xl font-medium font-secondary">Mes expériences</p>
                    <h3 class="md:text-[48px] text-[35px] leading-[1.25] mb-[23px] mt-1.5">Expériences professionelles
                    </h3>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 pt-[86px] gap-[25px]">
                <div class="cursor-pointer wow fadeInLeft" data-wow-duration="1s">
                    <div
                        ...
                        <div>
                            <h3 class="text-[30px] mb-4">Chargé de Communication</h3>
                            <p class="text-[21px] mb-5 font-medium font-secondary text-dark dark:text-white">
                                <span>PACIM (Association) Montpellier</span> <br>
                                <span class="text-2xl text-custom">Depuis Janvier 2023</span>
                            </p>
                            <p class="text-muted dark:text-darkmuted text-lg leading-[30px]">
                                Conception de supports de communication; Élaboration de la newsletter; Amélioration UX
                                du site; Participation à l’animation des réseaux sociaux; Animation de site internet.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="cursor-pointer wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.2s">
                    <div
                        class="shadow-[18px_0px_87px_rgba(10,15,17,0.07)] bg-white dark:bg-semilight p-8 lg:p-[65px] rounded-xl space-y-6 lg:space-y-0 lg:flex items-start gap-12 tilt-effect">
                        <div>
                            <h3 class="text-[30px] mb-4">Community Manager</h3>
                            <p class="text-[21px] mb-5 font-medium font-secondary text-dark dark:text-white">
                                <span>Zou Motel Bohicon, Bénin </span><br>
                                <span class="text-2xl text-custom">D'octobre 2021 à août 2022</span>
                            </p>
                            <p class="text-muted dark:text-darkmuted text-lg leading-[30px]">
                                Création de support visuel, animation des réseaux sociaux; <br>
                                Elaboration de la newsletter, gestion des partenariats
                            </p>
                        </div>
                    </div>
                </div>
                <div class="cursor-pointer wow fadeInLeft" data-wow-duration="1s">
                    <div
                        class="shadow-[18px_0px_87px_rgba(10,15,17,0.07)] bg-white dark:bg-semilight p-8 lg:p-[65px] rounded-xl space-y-6 lg:space-y-0 lg:flex items-start gap-12 tilt-effect">
                        <div>
                            <h3 class="text-[30px] mb-4">Journaliste Reporter</h3>
                            <p class="text-[21px] mb-5 font-medium font-secondary text-dark dark:text-white">
                                <span>Office de Radiodiffusion et Télévision du Bénin ( ORTB)</span> <br>
                                <span class="text-2xl text-custom">De juillet 2021 à octobre 2021</span>
                            </p>
                            <p class="text-muted dark:text-darkmuted text-lg leading-[30px]">
                                Réalisation de Reportages, d'interviews et de
                                magazines <br>
                                Chef d'édition du journal télévisé
                            </p>
                        </div>
                    </div>
                </div>
                <div class="cursor-pointer wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.2s">
                    <div
                        class="shadow-[18px_0px_87px_rgba(10,15,17,0.07)] bg-white dark:bg-semilight p-8 lg:p-[65px] rounded-xl space-y-6 lg:space-y-0 lg:flex items-start gap-12 tilt-effect">
                        <div>
                            <h3 class="text-[30px] mb-4">Mondoblogeur</h3>
                            <p class="text-[21px] mb-5 font-medium font-secondary text-dark dark:text-white">
                                <span>RFI (Atelier des médias) En distanciel</span> <br>
                                <span class="text-2xl text-custom">De mai 2021 à décembre 2021</span>
                            </p>
                            <p class="text-muted dark:text-darkmuted text-lg leading-[30px]">
                                Apprentissage et Utilisation du MS WordPress, Technique de SEO, Stratégie de
                                communication, Technique d’écriture journalistique
                            </p>
                        </div>
                    </div>
                </div>
    ...
    <section class="md:pt-[178px] pt-[120px] pb-[98px] md:pb-[160px] relative" id="service">
        <div class="container relative z-10">
            <div class="grid grid-cols-1">
                <div class="text-center max-w-[680px] mx-auto">
                    <p class="text-custom text-[20px] md:text-2xl font-medium font-secondary">Langues</p>
                    <h3 class="md:text-[48px] text-[35px] leading-[1.25] mb-[23px] mt-1.5">Langues parlées</h3>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 pt-[86px] gap-[25px]">
                ...
                <div class="cursor-pointer wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.2s">
                    <div
                        class="shadow-[18px_0px_87px_rgba(10,15,17,0.07)] bg-white dark:bg-semilight p-8 lg:p-[65px] rounded-xl space-y-6 lg:space-y-0 lg:flex items-start gap-12 tilt-effect">
                        <div>
                            <h3 class="text-[30px] mb-4">Anglais</h3>
                            <p class="text-muted dark:text-darkmuted text-lg leading-[30px]">
            ...
            <div class="bg-[url('../img/subscribe/dots.jpg')] relative rounded-xl py-[90px] px-7 md:px-[86px]">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 relative gap-y-10 lg:gap-y-0 items-center gap-4">
                    <div class="text-white wow fadeInLeft" data-wow-duration="1s">
                        <p class="md:text-[21px] text-[19px] font-medium font-secondary">Abonnez-vous maintenant</p>
                        <h4 class="mt-4 text-[35px] md:text-5xl">Recevoir ma newsletter</h4>
                        <p class="mt-4 text-lg">Recevez les dernières nouvelles, mises à jour, conseils et astuces dans
                            votre boîte de réception</p>
                    </div>
                    <div>
                        <div class="relative wow fadeInRight" data-wow-duration="1s">
                            <form method="post" action="">
                                <input type="email" class="form-input custom-mail" placeholder="Email" />
                                <input type="submit" value="Envoyez" class="sub-btn" />
                            </form>
                        </div>
                    </div>
                </div>
    ...
    <section class="md:pt-[190px] pt-[123px] pb-[120px] md:pb-[200px] relative" id="contact">
        <div class="container">
            <div class="grid grid-cols-1">
                <div class="text-center max-w-[680px] mx-auto">
                    <p class="text-custom text-[20px] md:text-2xl font-medium font-secondary">Contactez-moi</p>
                    <h3 class="md:text-[48px] text-[35px] leading-[1.25] mb-[23px] mt-1.5">Donnez moi de vos nouvelles
                    </h3>
                    <p class="text-muted dark:text-darkmuted text-lg leading-[30px]">Veuillez remplir le formulaire pour
                        me contacter. Ou appelez entre 9h00 et 22h00. HE, du lundi au dimanche</p>
                </div>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-2 mt-20 gap-[25px]">
                <div class="space-y-[15px] wow fadeInLeft" data-wow-duration="1s">
                    <div class="flex items-center gap-[25px]">
                        ...
                        <div>
                            <h5 class="md:text-[30px] text-[25px]">Adresse</h5>
                            <p class="text-lg mt-1.5 text-muted dark:text-darkmuted leading-8">Montpellier</p>
                        </div>
                    </div>
                    <div class="flex items-center gap-[25px]">
                        <div
                        ...
                        <div>
                            ...
                            <p class="text-lg mt-1.5 text-muted dark:text-darkmuted leading-8">gbelidjiprud@gmail.com
                            </p>
                        </div>
                    </div>
                    <div class="flex items-center gap-[25px]">
                        ...
                        <div>
                            ...
                            <p class="text-lg mt-1.5 text-muted dark:text-darkmuted leading-8">+33 0753752056</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="mapouter">
                        <div class="gmap_canvas rounded-xl">
                            <iframe width="100%" height="375" id="gmap_canvas"
                                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d92442.6926348079!2d3.8041290377093966!3d43.60999482026952!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x12b6af0725dd9db1%3A0xad8756742894e802!2sMontpellier%2C%20France!5e0!3m2!1sfr!2sbj!4v1680459638771!5m2!1sfr!2sbj"
    ...
    <section class="py-[60px] relative bg-[#f2f5fb] dark:bg-[#3f4453]">
        <div class="container">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5 items-center">
                <div>
                    <p class="text-muted dark:text-darkmuted text-base text-center md:text-left">Developpé par SALANON
                        Prudence © 2023</p>
                </div>
                <div>
    ...
    <div class="fixed h-[100px] w-px bottom-[25px] -right-[25px] bg-dark/10 z-10 duration-300 progressbar">
        <a href="#" class="no-underline text-dark"><span class="absolute bottom-[100px] left-0 text-[13px] text">To
                Top</span></a>
