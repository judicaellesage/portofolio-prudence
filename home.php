    ...
    <div class="container">
        <div class="grid lg:grid-cols-2 items-center gap-[25px]">
            <div class="order-2 lg:order-1">
                <h3 class="text-custom text-[21px] text-center lg:text-left lg:text-[25px] xl:text-[45px] leading-[1.3] font-medium font-secondary">Salut, je suis</h3>
                <h1 class="text-[42px] lg:text-[60px] xl:text-[85px] text-center lg:text-left mb-[11px] lg:mb-[18px] leading-[1.3] font-medium font-secondary" style="font-size: 30px;">Prudence SALANON,</h1>
                <p class="lg:mb-9 mb-[15px] text-lg lg:text-[19px] xl:text-[28px] text-center lg:text-left font-medium">
                    <span class="text-[#1cbe59]">Chargé de communication</span> à <span class="text-[#8067f0] dark:text-[#f0c45c]">Montpellier</span>
                </p>
                <p class="lg:mb-[42px] text-muted dark:text-white mb-[30px] text-base text-center lg:text-left xl:text-[23px] leading-[1.5] max-w-[640px] mx-auto lg:ml-0">
                    Je suis chargé de communication basé à Montpellier, et je suis très passionné et dévoué à mon travail.
                </p>
            ...
            <div class="order-1 lg:order-2">
                <div class="relative">
                    <img src="assets/img/slider/avatar.png" class="mx-auto max-w-[250px] lg:max-w-[400px] xl:max-w-[650px]" alt="" />
